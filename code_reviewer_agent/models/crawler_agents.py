...
class ConfigArgs(Dict[str, Any]): pass

class CrawledDocument(Dict[str, Any]): pass

class CrawledDocuments(List[CrawledDocument]): pass
...
class CrawlerAgents:
    ...
    def __init__(self, config: Config, urls: Urls):
        self._config = config
